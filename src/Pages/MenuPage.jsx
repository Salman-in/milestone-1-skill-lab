...
const menuData = [
  { id: 1, name: "Garlic Bread", category: "Starters", description: "Toasted bread with garlic and herbs", price: "Rs.199", image: "https://media.istockphoto.com/id/547046390/photo/garlic-bread.jpg?s=612x612&w=0&k=20&c=oArNgkbjjPKlToDnBhL7xNwU4_eJLPTaLbAlIuunHDY=", dietary: "Vegan" },
  ...
  { id: 4, name: "Kunafa", category: "Desserts", description: "Juicy steak cooked to perfection", price: "Rs.399", image: "https://www.unileverfoodsolutions.pk/dam/global-ufs/mcos/meps/pakistan/calcmenu/recipes/PK-recipes/desserts-&-bakery/custard-kunafa/main-header.jpg", dietary: "Vegetarian" },
...
const dietaryOptions = ["All", "Vegan", "Vegetarian", "Gluten-Free", "Non-Vegetarian"];
